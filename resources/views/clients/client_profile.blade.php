...
<nav>
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        <a class="nav-item nav-link" data-toggle="tab" href="#nav-indicators" role="tab" aria-selected="false">HEI Profile</a>
    </div>
</nav>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane " id="appointments" role="tabpanel">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 col-xs-6 b-r"> <strong>Total Appointments : </strong>
                                                        <br>
                                                        <p class="text-muted all_appointments"></p>
                                                    </div>
                                                    <div class="col-md-4 col-xs-6 b-r "> <strong>Future Appointments : </strong>
                                                        <br>
                                                        <p class="text-muted current_appointments"></p>
                                                    </div>

                                                    <div class="col-md-4 col-xs-6"> <strong>Kept Appointments : </strong>
                                                        <br>
                                                        <p class="text-muted kept_appointments "></p>
                                                    </div>
                                                    <div class="col-md-4 col-xs-6"> <strong>Missed Appointments : </strong>
                                                        <br>
                                                        <p class="text-muted missed_appointments "></p>
                                                    </div>
                                                    <div class="col-md-4 col-xs-6 b-r"> <strong>Defaulted Appointments : </strong>
                                                        <br>
                                                        <p class="text-muted defaulted_appointments"></p>
                                                    </div>
                                                    <div class="col-md-4 col-xs-6 b-r "> <strong>LTFU Appointments : </strong>
                                                        <br>
                                                        <p class="text-muted LTFU_appointments"></p>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-xs-6 b-r "> <strong>No of Appointments by Type: </strong>
                                                        <ul class=" text-muted client_appointment_types">Re-Fill: </ul>
                                                        <ul class=" text-muted client_appointment_types">Clinical Review: </ul>
                                                        <ul class=" text-muted client_appointment_types">Enhanced Adherence: </ul>
                                                        <ul class=" text-muted client_appointment_types">Lab Investigation: </ul>
                                                        <ul class=" text-muted client_appointment_types">Viral Load: </ul>
                                                        <ul class=" text-muted client_appointment_types">Other: </ul>
                                                    </div>
                                                </div>
