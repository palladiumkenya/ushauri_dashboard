...
class CalendarController extends Controller
{
    ...
    public function current_appointments($slug,$id)
    {
        ...
        $query = DB::table('tbl_client')
                ...
                ->select('tbl_client.file_no', 'tbl_appointment.id as appointment_id', 'tbl_client.f_name', 'tbl_client.m_name', 'tbl_client.l_name', 'tbl_client.phone_no', 'tbl_client.status','tbl_client.clinic_number','tbl_client.id as client_id','tbl_appointment.appntmnt_date','tbl_appointment.app_type_1','tbl_appointment_types.id as appointment_types_id','tbl_appointment_types.name as appointment_types', 'tbl_clinic.name as clinic')
